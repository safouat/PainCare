                ...
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <ul class="bread-crumb clearfix">
                            ...
                            <li>
                              <a class="btn-box theme-btn" data-bs-toggle="modal" data-bs-target="#partInfoModal1" href="publish" role="button">
    Publish
</a>
      ...
      <c:forEach var="blog" items="${blogs}">
        <tr>
            ...
            <td class="table-action">
                <a href="remove_blog?blog_id=${blog.getID()}" class="action-icon"> <i class="mdi mdi-pencil"><i class="fas fa-trash"></i></a>
                <a href="update_blog?id=${blog.getID()}" class="action-icon"> <i class="fas fa-edit"></i></a>
            </td>
        </tr>
        </c:forEach>
