    ...
    <%@include file="/WEB-INF/comps/header.jsp" %>
        ...
        <div class="app-form-cnt container">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control form-control-lg inp " placeholder="Type the Username.."
                        x-model="fileName" value="${userBean.getName()}" name="name" id="name" placeholder="Username">

                </div>
                <div class="mb-3">

                    <input name="birth-day" type="date" class="form-control form-control-lg" id="birth-day"
                ...
                <div class="mb-3">
                    <div class="container">
                        <label class="custum-file-upload" for="file">
                            ...
                            <div class="text">
                                <span>Upload Profile Imaage</span>
                            </div>
                            <input class="form-control" type="file" name="avatar" type="file" id="avatar"
